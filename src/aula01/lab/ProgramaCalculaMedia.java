...
public class ProgramaCalculaMedia {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null,"Média do(a) Aluno(a) " + nomeAluno1 + " (Matrícula - " + matAluno1 + ") = " + df.format(mediaAluno1));
		JOptionPane.showMessageDialog(null,"Média do(a) Aluno(a) " + nomeAluno2 + " (Matrícula - " + matAluno2 + ") = " + df.format(mediaAluno2));
		JOptionPane.showMessageDialog(null,"Média do(a) Aluno(a) " + nomeAluno3 + " (Matrícula - " + matAluno3 + ") = " + df.format(mediaAluno3));
		JOptionPane.showMessageDialog(null,"Média do(a) Aluno(a) " + nomeAluno4 + " (Matrícula - " + matAluno4 + ") = " + df.format(mediaAluno4));
